...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($title === "") {
        ...
        $stmt = $conn->prepare("
            ...
            (user_id, title, issuer, description, certificate_date)
            VALUES (?, ?, ?, ?, ?)
        ");
...
<title>Add Certificate - AchieveX</title>
...
<div class="content">
    ...
    <p class="subtitle">
        Add a certificate to your AchieveX profile.
    </p>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    id="issuer"
                    name="issuer"
                    placeholder="Example: Google, Coursera, Udemy"
                >
